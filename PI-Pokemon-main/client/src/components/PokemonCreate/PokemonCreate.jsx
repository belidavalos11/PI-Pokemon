...
import oak2 from '../../images/oak2.gif'
...
export default function PokemonCreate(){
    ...
    return(
        <div className={style.pagina}>
            ...
            <Link to='/home' className={style.return}><button className={style.retbtn}>Return home</button></Link>
            <div className={style.container}>
                ...
                <form onSubmit={ (e) => handleSubmit(e) }>
                    ...
                    <button className={style.next} onClick={(e) => {handleSection(e)}}>Next</button>
                    </section>

                    <section className={section === 2 ? style.show : style.hide}>
                        <div style={{position:'relative'}}> 
                            <span className={style.choosetypes} style={{display:'flex', justifyContent:'flex-start', fontFamily:'Poppins'}}>Choose up to 2 Pokemon types</span>
            ...
            <img src={Oak} alt="Profesor Oak" height="500px" className={style.img}/>
        </div>
    )
}
